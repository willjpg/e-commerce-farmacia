package com.generation.ecommerce.farmacia.controller;
...
import com.generation.ecommerce.farmacia.repository.CategoriaRepository;
import com.generation.ecommerce.farmacia.repository.ProdutoRepository;
...
public class ProdutoController {
	...
	@GetMapping("/nome/{nome}/andlaboratorio/{laboratorio}")
	public ResponseEntity <List<Produto>> getByNomeAndLaboratorio(@PathVariable String nome, String laboratorio){
		return ResponseEntity.ok(produtoRepository.findByNomeAndLaboratorio(nome, laboratorio));
	
	}
	@GetMapping("/nome/{nome}/orlaboratorio/{laboratorio}")
	public ResponseEntity <List<Produto>> getByNomeOrLaboratorio(@PathVariable String nome, String laboratorio){
